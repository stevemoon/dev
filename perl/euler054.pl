...
# Euler 54 - poker In the card game poker, a hand consists of five
# cards and are ranked, from lowest to highest, in the following way:

#     High Card: Highest value card. One Pair: Two cards of the same
#     value. Two Pairs: Two different pairs. Three of a Kind: Three
#     cards of the same value. Straight: All cards are consecutive
#     values. Flush: All cards of the same suit. Full House: Three of
#     a kind and a pair. Four of a Kind: Four cards of the same value.
